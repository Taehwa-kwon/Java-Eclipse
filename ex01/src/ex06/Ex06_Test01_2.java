...
public class Ex06_Test01_2 {

	public static void main(String[] args) {
		//문자열 찾기
		String s1 = "이순신";
		System.out.println( s1.contains("순신")); //일부 포함의 여부  (내용만 비교)
		System.out.println( s1.contentEquals("순신")); // 전체일치  (내용만 비교) 
		System.out.println(s1.equals("이순신"));	// 매개변수의 객체가 String의 인스턴스인지도 확인 가능  앞뒤 모두 String 타입을 확인한 후 내용비교
